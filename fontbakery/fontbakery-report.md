 ...
 * U+0307 COMBINING DOT ABOVE: try adding one of: malayalam, tai-le, syriac, coptic, tifinagh, canadian-aboriginal, math, old-permic
...
Your font does *not* cover the following languages that require the soft-dotted feature: Nateni (Latn, 100,000 speakers), Basaa (Latn, 332,940 speakers), Bafut (Latn, 158,146 speakers), Avokaya (Latn, 100,000 speakers), Gulay (Latn, 250,478 speakers), Sar (Latn, 500,000 speakers), Aghem (Latn, 38,843 speakers), South Central Banda (Latn, 244,000 speakers), Ijo, Southeast (Latn, 2,471,000 speakers), Lugbara (Latn, 2,200,000 speakers), Zapotec (Latn, 490,000 speakers), Navajo (Latn, 166,319 speakers), Mango (Latn, 77,000 speakers), Ejagham (Latn, 120,000 speakers), Ebira (Latn, 2,200,000 speakers), Dan (Latn, 1,099,244 speakers), Fur (Latn, 1,230,163 speakers), Igbo (Latn, 27,823,640 speakers), Nzakara (Latn, 50,000 speakers), Koonzime (Latn, 40,000 speakers), Ma’di (Latn, 584,000 speakers), Kom (Latn, 360,685 speakers). [code: soft-dotted]
